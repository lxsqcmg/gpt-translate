...
Postman可在Web上使用，网址为**[go.postman.co/home](https://go.postman.co/home)**，也可作为本机桌面应用程序使用，支持Mac（Intel或Apple Silicon）、Windows（Intel 32位或64位）和Linux（64位）操作系统。
...
> * Debian 8及更高版本
>
> 某些Linux发行版的支持取决于它们是否受Electron支持。请参阅[Electron文档](https://www.electronjs.org/docs/latest/development/build-instructions-linux)。
>
...
Postman没有固定的IP范围可提供。如果必要，请参考[当前的AWS IP范围](https://docs.aws.amazon.com/general/latest/gr/aws-ip-ranges.html)并允许提供的广泛范围。

## 故障排除Postman安装

如果您在安装和运行Postman时遇到任何问题，请查看以下提示。如果这些提示无法帮助您，请参考[社区论坛](https://community.postman.com/tags/installation)上的安装帖子，并在您的问题尚未涵盖的情况下创建新帖子。您也可以联系[Postman支持](https://www.postman.com/support)。
...
如果您正在使用Linux的Postman，并使用Ubuntu软件中心或Snap Store安装了应用程序，则可能没有__检查更新__选项。这是因为更新由商店处理，会定期自动更新Postman。