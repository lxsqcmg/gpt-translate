...
contextual_links:
  ...
  - type: subtitle
    name: "视频"
  - type: link
    name: "揭秘Postman v10的新功能 | Postman Intergalactic"
...
要获取Postman桌面应用程序的早期版本，请参见[安装早期版本的Postman](/docs/administration/updating/#installing-earlier-versions-of-postman)。
...
您可以在Web浏览器中使用Postman，与Postman代理一起执行API开发和测试任务。要访问Postman Web应用程序，请访问[go.postman.co/home](https://go.postman.co/home)。
...
如果您正在使用Postman Web应用程序，Postman建议下载并安装[Postman桌面代理](/docs/getting-started/about-postman-agent/#the-postman-desktop-agent)，这是一个在您的桌面本地运行的微型应用程序。桌面代理克服了浏览器的跨源资源共享（CORS）限制，并充当您从Postman Web应用程序发出API请求的代理。

### Web限制

Postman Web应用程序正在积极开发中。您只能在Postman桌面应用程序中访问某些功能，而无法在浏览器中访问：
...
* 本机应用程序允许您发送诸如“Origin”和“User-Agent”之类的标头。这些在Chrome应用程序中受到限制。
...
如果在Postman中收到__Update Failed__通知，则可以使用DevTools进行调查。
...
如果您正在使用Linux上的Postman，并使用Ubuntu软件中心或Snap Store安装了应用程序，则可能没有__检查更新__选项。这是因为更新由商店处理，商店会定期自动更新Postman。